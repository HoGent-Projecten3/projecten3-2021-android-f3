...
class HotelFragment : Fragment() {
    ...
    private fun activateAnimations(binding: FragmentHotelBinding) {
        // bali
        binding.imageBali.apply {
            setBackgroundResource(R.drawable.final_bali_idle)
            baliIdleAnimation = background as AnimationDrawable
        }
        baliIdleAnimation.start()
        // bar
        binding.imageBar.apply {
            setBackgroundResource(R.drawable.final_bar_idle)
            barIdleAnimation = background as AnimationDrawable
        }
        barIdleAnimation.start()
        // trofee
        binding.imageTrofee.apply {
            setBackgroundResource(R.drawable.final_trofee_idle)
            trofeeIdleAnimation = background as AnimationDrawable
        }
        trofeeIdleAnimation.start()
        // bib
        binding.imageBib.apply {
            setBackgroundResource(R.drawable.final_bib_idle)
            bibIdleAnimation = background as AnimationDrawable
        }
        bibIdleAnimation.start()
        // cinema
        binding.imageCinema.apply {
            setBackgroundResource(R.drawable.final_cinema_idle)
            cinemaIdleAnimation = background as AnimationDrawable
        }
        cinemaIdleAnimation.start()
        // penthouse
        binding.imagePenthouse.apply {
            setBackgroundResource(R.drawable.final_penthouse_idle)
            penthouseIdleAnimation = background as AnimationDrawable
        }
        penthouseIdleAnimation.start()
        // entrance
        binding.imageEntrance.apply {
            setBackgroundResource(R.drawable.final_entrance_idle)
